...
<body>
  ...
  <div class="container">
    ...
    <form class="m-5" action="./update.php" method="POST">
      ...
      <div class="form-group">
        <label for="amount">内容</label>
        <input type="text" class="form-control" id="amount" name="amount" value="<?= h($record['amount']); ?>">
      </div>
      <div class="form-group">
        <div class="form-check form-check-inline">
          ...
          >
          <label class="form-check-label" for="income">input</label>
        </div>
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="radio" name="type" id="spending" value="1"
            <?= h($record['type']) == 1 ? 'checked' : '';  ?>
          >
          <label class="form-check-label" for="spending">output</label>
        </div>
      </div>
      <div class="form-group">
